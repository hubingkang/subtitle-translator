  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between text-sm">
            <span className="font-medium">Subtitle Progress</span>
            <span className="text-muted-foreground">
          ...
          <div className="text-center p-4 rounded-lg bg-muted/50 border">
            ...
            <div className="text-sm text-muted-foreground">
              of {total} subtitles translated
            </div>
            {failed > 0 && (
              <div className="text-xs text-red-500 mt-1">({failed} failed)</div>
            )}
          </div>
        </div>
        ...
        {!isActive && total > 0 && completed + failed === total && (
          <>
            ...
            >
              ...
              >
                {failed === 0
                  ? `All ${completed} subtitle entries translated successfully`
                  : `${completed} subtitles translated successfully, ${failed} failed`}
              </div>
            </div>
          </>
        )}
